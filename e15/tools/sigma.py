...
# def calc_delta(dataframe, num=5):
#     # smooth and calculate velocity fluctuation
#     Vr_smo = smooth(dataframe.vr, num)
#     Vt_smo = smooth(dataframe.vt, num)
#     Vn_smo = smooth(dataframe.vn, num)
...
#     # calculate change in velocity and magnetic field fluctuations
#     delta_v = np.sqrt(delta_Vr**2 + delta_Vt**2 + delta_Vn**2)
#     delta_b = np.sqrt(delta_Vrb**2 + delta_Vtb**2 + delta_Vnb**2)
...
#     Zp = np.sqrt(Zpr**2 + Zpt**2 + Zpn**2)
#     Zm = np.sqrt(Zmr**2 + Zmt**2 + Zmn**2)

#     return [Zpr, Zpt, Zpn], [Zmr, Zmt, Zmn], [delta_Vr, delta_Vt, delta_Vn], [delta_Vrb, delta_Vtb, delta_Vnb]