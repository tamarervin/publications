...
def calc_sigma(dataframe, mag, num=5):
    ...
    Vra = calc_vA(mag.Br, dataframe.use_dens.values)
    Vta = calc_vA(mag.Bt, dataframe.use_dens.values)
    Vna = calc_vA(mag.Bn, dataframe.use_dens.values)
